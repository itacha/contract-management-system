...
export class ListDetailComponent extends BaseOfSimpleForm {
  @Input()
  item: any;
  @Input()
  ...
  ngOnInit() {
    ...
    if (this.item.applyStatus == '0') {
      this.hiddenOpinion = false;
    } else {
      this.hiddenOpinion = true;
    }
